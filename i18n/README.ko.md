...
*AppBoard는 [LaunchNext](https://github.com/RoversX/LaunchNext)와 [LaunchNow](https://github.com/ggkevinnnn/LaunchNow)(작성자: ggkevinnnn)를 기반으로 개발되었습니다 — 원본 프로젝트에 깊이 감사드립니다! ❤️*
